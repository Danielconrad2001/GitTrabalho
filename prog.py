...
class Store:  
    ...
    def menu_inicial(self): # menu inicial, no qual possui as primeiras funcionalidades do programa.
        self.linha()
        print('''
        [1] - CADASTRAR
        [2] - LOGIN
    ...
    def menu_loja(self, carrinho): # menu loja, em que temos as principais funções do programa.
        self.linha()
        print('''
        [1] - VER PRODUTOS
        [2] - VER CARRINHO
    ...
    def linha(self): # função que printa uma linha e auxilia na organização do programa.
        print('=='*33)
        

    def exit(self): # função para encerrar o funcionamento do programa.
        exit()


    def logar(self): # função para solicitar as informações para logar no programa.
        while True:
    ...
    def verificar_usuario(self, cpf, senha): # função para verificar as informações solicitadas acima.
        r_user = []
    ...
    def ver_produtos(self, produtos): # função para exibir ao usuário todos os produtos registrados no .txt.
    ...
    def descontar_saldo(self, cpf, novo_saldo, carrinho): # função para descontar os produtos do carrinho no saldo do usuário, se o mesmo tiver limite disponível.
    ...
    def pagar_conta(self, cpf, carrinho, usuario_atual): # função para pagar todas as dividas do usuario e os itens que ele estiver no carrinho no momento.
        senha = input('Digite sua senha para confirmar o pagamento ou [0] para voltar: ')
        if senha == '0':
            self.opcoes_pagamento()
        else:
    ...
    def meus_dados(self, usuario): # função para mostrar os dados do usuário logado no momento.
        self.linha()
        print()
    ...
    def cpf_formatado(self, cpf): # função para pegar o cpf do usuário logado e colocar ele formatado.
        cpf_f = ''
        c = 0
        for i in cpf:
            cpf_f += i
    ...
    def conferir_senha(self, senha, cpf): # função para conferir a senha do usuario. 
        r_user = []
    ...
    def saldo_atual(self, cpf): # função para verificar o saldo atual do usuário.
        r_user = []
        with open('a_user_register.txt','r') as arquivo:
            for l in arquivo:
                r_user.append(l.split(','))
